...
-===================-
"""
KAC=[cl,ki,kk,kc,ko,ks,ka,kb,ke,ku,kj,mj,k2,k3,k4,b1]
Bots=[cl,ki,kk,kc,ko,ks,ka,kb,ke,ku,kj,mj,k2,k3,k4,b1]
...
Bots=[mid,Amid,Bmid,Cmid,Gmid,Dmid,Emid,Fmid,Hmid,Jmid,Mmid,Kmid,K2mid,B1mid,K4mid,"ue5c53b616f883dcb82526ad2b3c66f15"]
admin=["uba553877e995e2bd476d1d78469dc8d2","ue5c53b616f883dcb82526ad2b3c66f15","u2296eb02bd6b9a7cfa8e4f37951f32d6","u0bf068804282882778197aee44a735eb","u8e6978875c4302d599b3daf1f92afe28","u735e0b1595e6e1f517bb6622830846e5","u4614617232df33da4877715c33ae4f9e","u77abe23ec9b63932ad714457878bd0f8","u84c046170aaca01b9038425b42425461","u7df4891f97bd8aab51f3b8e8534106d4","ucd8b1a1b1c146718abc766fc1c4ae8e1","u5f02b8efaf59e3b1ad8a6da10ac1da84","ubf04dbb1720c7d3431d4301f034be5e9","uf36cb0dd27f46cded21aa5f2e525c171","u1b9ab645520fa5ae9d734f6e6b9b56ba","ufa6afcbcac1bbfbc80008a6aebad5b27","u0489c1e5714d680431783066fbfdad8a"]
    ...
    try:
        ...
        if op.type == 15:
            if op.param2 in Bots:
                return
            ki.sendText(op.param1, "Yahh Meninggal R Gih Kaka")
            print "MemberLeft"
        ...
        if op.type == 32:
                if not op.param2 in Bots and admin:
                    if wait["protectionOn"] == True: 
                        try:
                            klist=[ki,kk,kc,ke,ko,ks,ku,ka,kb,b1,kj,mj,k2,k3,k4]
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                cl.sendText(msg.to,mid)
            elif "Der1 mid" == msg.text:
                ki.sendText(msg.to,Amid)
            elif "Der2 mid" == msg.text:
                kk.sendText(msg.to,Bmid)
            elif "Der3 mid" == msg.text:
                kc.sendText(msg.to,Cmid)
            ...
            elif msg.text in ["CONTEMPORARY"]:
              if msg.from_ in admin:
                string = msg.text.replace("哦上的 ","")
                if len(string.decode('utf-8')) <= 20:
                    profile_B = mj.getProfile()
                    profile_B.displayName = string
                    mj.updateProfile(profile_B)
                    mj.sendText(msg.to,"name " + string + " done")
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            ...
                            pass
            elif "Pusing." in msg.text:
              if msg.from_ in admin:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Pusing.","")
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
                    ki.sendText(msg.to,"Ini Room apa? ? Mugiwara Sita!!")
                    kk.sendText(msg.to,"Group Di Sita.")
                    kj.sendText(msg.to,"Tagkis Woiii")
                    kc.sendText(msg.to,"Pasrah bgst jangan panik")
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                kk.sendText(msg.to,"Group Disita")
                                kc.sendText(msg.to,"Group Disita")
            elif "Nk " in msg.text:
                  if msg.from_ in admin:
                    ...
                    if msg.toType == 2:
                        ...
                        for g in gs.members:
                                if _name in g.displayName:
                                        targets.append(g.mid)
                        if targets == []:
                                cl.sendText(msg.to,"Tidak Ada Boss Owner Gue")
                        else:
                                for target in targets:
                                        try:
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                k4.sendText(msg.to,"ASL Hadir")
                b1.sendText(msg.to,"Hiken Hadir")
                k2.sendText(msg.to,"Bokapnya Luffy Hadir")
                kj.sendText(msg.to,"Unknown¹")
                k3.sendText(msg.to,"Unknown²")
                mj.sendText(msg.to,"unknown³")
#-----------------------------------------------
    ...
    while True:
        ...
        #while a2():
            ...
            if wait["clock"] == True:
                ...
                profile3 = kj.getProfile()
                profile3.displayName = wait["cName3"]
                kj.updateProfile(profile3)
            time.sleep(800)
        except:
            pass
